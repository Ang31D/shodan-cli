...
class DateHelper:
	...
	def last_day_in_month(self):
		last_date_of_month = DateHelper(datetime(self.year, self.month_digits, 1) + relativedelta(months=1, days=-1))
		return last_date_of_month.day_digits
...
def testing(args):
	...
	today_date = DateHelper(DateHelper.format_date("2024-02-01 00:00:00", DateHelper.DATETIME_FORMAT_STANDARD))
	print(today_date.last_day_in_month)
