...
The python script `shodan-cli.py` utilizes the shodan api to fetch, filter and show host services information ([https://shodan.readthedocs.io/](https://shodan.readthedocs.io/)).
